        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="col-11 text-end">
                    <a href="{{URL::to('/add-sub-category')}}" class="btn bg-gradient-dark mb-0"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add SubCategory</a>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2">SubCategory Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        ?>
                                            <a href="{{URL::to('/active-sub-category/'.$sub->subcategory_id)}}"><i class="material-icons" style="font-size: 40px; color:red;">thumb_down</i></a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <a onclick="return confirm('Are you sure to delete?')" href="{{URL::to('/delete-sub-category/'.$sub->subcategory_id)}}" class="font-weight-bold" data-toggle="tooltip">
