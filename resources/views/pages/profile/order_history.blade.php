                ...
                <ul>
                    <li class="{{ Route::currentRouteNamed('profile.account') ? 'active' : '' }}"">
                        ...
                        <div class="d-flex flex-column">
                            <div class="link">{{ __('profile/OrderHistory.My Profile') }}</div>
                            <div class="link-desc">{{ __('profile/OrderHistory.Change your profile') }}</div>
                        </div>
                        </a>
                    </li>
                    <li class="{{ Route::currentRouteNamed('profile.chgpwd') ? 'active' : '' }}"">
                        ...
                        <div class="d-flex flex-column">
                            <div class="link">{{ __('profile/OrderHistory.Password') }}</div>
                            <div class="link-desc">{{ __('profile/OrderHistory.Change your password') }}</div>
                        </div>
                        </a>
                    </li>
                    <li class="{{ Route::currentRouteNamed('profile.order') ? 'active' : '' }}"">
                        ...
                        <div class="d-flex flex-column">
                            <div class="link">{{ __('profile/OrderHistory.My Order') }}</div>
                            <div class="link-desc">{{ __('profile/OrderHistory.View & Manage your orders') }}</div>
                        </div>
                        </a>
                    </li>
                </ul>
